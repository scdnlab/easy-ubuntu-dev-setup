...
sudo apt-get install php7.0 php7.0-fpm php7.0-mysql php7.0-curl php7.0-json php7.0-cgi libapache2-mod-php7.0 php7.0-zip php7.0-mcrypt php7.0-mbstring php7.0-xml php-xml php7.0-intl
